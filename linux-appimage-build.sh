...
cp src/liblouis_table_editor/styles.qss AppDir/usr/share/styles.qss
cp src/liblouis_table_editor/styles.qss AppDir/usr/bin/styles.qss
cp src/liblouis_table_editor/styles.qss AppDir/usr/bin/_internal/styles.qss

pyinstaller --onefile --windowed --name liblouis-table-editor \
  --add-data "src/liblouis_table_editor/assets:assets" \
  --add-data "src/liblouis_table_editor/styles.qss:_internal/styles.qss" \
  --add-data "src/liblouis_table_editor/styles.qss:styles.qss" \
  src/liblouis_table_editor/__main__.py
...
cp src/liblouis_table_editor/assets/icons/icon.ico AppDir/liblouis-table-editor.png
